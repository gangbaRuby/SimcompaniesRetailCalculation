function onCheckboxClick(e) {
  ...
  if (sheetName == 'R1计算器' || sheetName == 'R2计算器' || sheetName == 'R1固定利润算成本' || sheetName == 'R2固定利润算成本' || sheetName == 'R1计算器（最大销售速度）' || sheetName == 'R2计算器（最大销售速度）' || sheetName == 'R1固定利润算最大销售速度' || sheetName == 'R2固定利润算最大销售速度') { // 限制使用表
